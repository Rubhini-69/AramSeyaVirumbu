        ...
        <section class="signup">
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form action = "include\signup.inc.php" method="POST" class="register-form" id="register-form">
                            ...
                            <div class="form-group">
                                <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="text" name="uid" id="name" placeholder="Your Username"/>
                            </div>
                            <div class="form-group">
            ...
            if(isset($_GET["error"])){
                if($_GET["error"] == "emptyinput"){
                    ...
                    echo "<p>Choose a proper Usernamer!</p>";
